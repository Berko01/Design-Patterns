...
public class NumberOfCovidDeathsVisitor implements Visitor{
    @Override
    ...
    private int calculateNumberOfPatients(Hospital hospital) {
        return CalculateNumberOfPatientUtil.calculateNumberOfPatients(hospital, EnumIlness.COVID, EnumPatientCondition.DEATH);
