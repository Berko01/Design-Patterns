...
public class NumberOfCovidGotBetterVisitor implements Visitor{
    ...
    private int calculateNumberOfPatients(Hospital hospital) {
        return CalculateNumberOfPatientUtil.calculateNumberOfPatients(hospital, EnumIlness.COVID, EnumPatientCondition.GOT_BETTER);
    }
