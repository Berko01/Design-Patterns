...
public class NumberOfSeriouslyIllPatientsWithCovid implements Visitor{
    ...
    private int calculateNumberOfPatients(Hospital hospital) {
        return CalculateNumberOfPatientUtil.calculateNumberOfPatients(hospital, EnumIlness.COVID, EnumPatientCondition.SERIOUSLY_ILL);
